...
res.end('<h1>สวัสดีค่ะ! นี่คือ Web Server ของ นางสาวมนัสนันท์ มุขโพธิ์เย็น และ รหัสนักศึกษา 69319010012 </h1><p>เครื่องแมขายทํางานปกติบนระบบ Railway แลวครับผม!</p>');
});
